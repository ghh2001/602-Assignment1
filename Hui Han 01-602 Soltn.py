...
def exercise08():
    # Assign 5 to the variable qty, 'hello' to the variable hello and a variable hello_repeated that holds a string that contains whatever is contained in the variable hello repeated quantity times
    # ------ Place code below here \/ \/ \/ ------
   qty = 5
   hello = 'hello'
   hello_repeated = hello * qty
  
    # ------ Place code above here /\ /\ /\ ------
   return qty, hello, hello_repeated
